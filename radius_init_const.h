...
REGISTER_LONG_CONSTANT("RADIUS_OPTION_NONE", 0, CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("RADIUS_OPTION_TAGGED", 1, CONST_PERSISTENT);
REGISTER_LONG_CONSTANT("RADIUS_OPTION_SALT", 2, CONST_PERSISTENT);
...
REGISTER_LONG_CONSTANT("RADIUS_VENDOR_JUNIPER", 4874, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_VIRTUAL_ROUTER", 1, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_LI_ACTION", 58, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_MED_DEV_HANDLE", 59, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_MED_IP_ADDRESS", 60, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_MED_PORT_NUMBER", 61, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_ACTIVATE_SERVICE", 65, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_DEACTIVATE_SERVICE", 66, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_SERVICE_VOLUME", 67, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_SERVICE_TIMEOUT", 68, CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("RADIUS_ERX_SERVICE_STATISTICS", 69, CONST_PERSISTENT);
